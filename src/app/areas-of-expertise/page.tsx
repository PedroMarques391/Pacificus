      ...
      <Layout>
        ...
        >
          <ExpertiseCard title='Fusões e Aquisições'>
            <p>Na vanguarda do mundo empresarial, a Pacificus & Associados se destaca como uma referência em assessoria jurídica estratégica, oferecendo soluções personalizadas e inovadoras para uma variedade de desafios corporativos. Com uma equipe de advogados altamente qualificados e especializados em diversas áreas do Direito Empresarial, a Pacificus & Associados se posiciona como parceira essencial para empresas que buscam crescer, expandir e se destacar em um ambiente competitivo.</p>
