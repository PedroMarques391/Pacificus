    ...
    return (
        <section className='flex flex-col justify-between items-center w-full lg:w-[450px] lg:h-[650px] p-5 border border-gray-400 rounded-xl'>
            <div className='flex justify-center items-center lg:gap-x-5'>
                {IconUser}
                <div>
                    <H1 className='text-xl my-3 uppercase tracking-wider'>{name}</H1>
                    <H1 className='text-lg my-3'>{email}</H1>
                </div>
            </div>

            <div className='w-full ml-5'>
                <H1 className='text-xl text-black/100 text-start'>Formação</H1>
                <ul className='flex text-lg flex-col gap-y-3 text-light-200 list-disc'>
            ...
            <div className='w-full ml-5'>
                <H1 className='text-xl text-black/100 text-start'>Sobre o Profissional</H1>
                <ul className='flex text-lg flex-col gap-y-3 text-light-200 list-disc'>
                    {more.map((more, index) => (
                        <li key={index}>
                            {more}
