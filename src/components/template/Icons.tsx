...
export const IconBars: JSX.Element = (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 dark:text-white">
...
export const IconFacebook = (size: string): JSX.Element => (
...
export const IconInstagram = (size: string): JSX.Element => (
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={size} height={size} viewBox="0 0 48 48">
...
export const IconLinkedin = (size: string): JSX.Element => (
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width={size} height={size} viewBox="0 0 48 48">
