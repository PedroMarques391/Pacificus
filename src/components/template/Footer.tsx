...
const Footer = (): React.JSX.Element => {
    return (
        <footer className="bg-black flex flex-col lg:flex-row text-xl justify-center p-10 gap-10">
            ...
            <section className="text-white w-full lg:w-1/3 text-center mx-auto order-3 lg:order-2">
            ...
            <section className="text-white w-full lg:w-1/3 text-center order-2 lg:order-3">
